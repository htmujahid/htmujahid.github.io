...
export const EXPERIENCES = [
  {
    ...
    technologies: ["React JS", "Next JS", "Supabase", "Postgres"],
  },
  {
    company: "Invogue Solutions",
  ...
  },
  {
    ...
    location: "Remote",
    description: [
      "Delivered custom web solutions for small businesses and entrepreneurs",
      "Provided ongoing maintenance and support for client websites",
      "Developed strong client relationships resulting in 90% repeat business rate",
    ],
    technologies: ["React JS", "Next JS", "Tailwind CSS", "Supabase", "Postgres"],
  },
]